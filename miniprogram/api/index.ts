...
import * as taskDisposalController from "./taskDisposalController";
import * as taskCheckinController from "./taskCheckinController";
import * as publicizeWxPlatformController from "./publicizeWxPlatformController";
...
export default {
  userController,
  taskTrackController,
  taskInspectionController,
  taskDisposalController,
  taskCheckinController,
  publicizeWxPlatformController,
